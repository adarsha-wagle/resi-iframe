...
import {
  RoofingQuesOneSchema,
  type TRoofingQuesOneSchema,
} from "../common/roofing_types";
import { zodResolver } from "@hookform/resolvers/zod";

function RoofingQuesOne() {
  const { control, handleSubmit } = useForm<TRoofingQuesOneSchema>({
    resolver: zodResolver(RoofingQuesOneSchema),
  });

  const onSubmit = (values: TRoofingQuesOneSchema) => {};

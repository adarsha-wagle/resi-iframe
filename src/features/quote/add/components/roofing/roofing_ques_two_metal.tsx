...
import {
  RoofingQuesTwoMetalSchema,
  type TRoofingQuesTwoMetalSchema,
} from "../common/roofing_types";
import { zodResolver } from "@hookform/resolvers/zod";

function RoofingQuesTwoMetal() {
  const { control, handleSubmit } = useForm<TRoofingQuesTwoMetalSchema>({
    resolver: zodResolver(RoofingQuesTwoMetalSchema),
  });

  const onSubmit = (values: TRoofingQuesTwoMetalSchema) => {};
...
export default RoofingQuesTwoMetal;
